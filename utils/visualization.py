...
Plotly chart builders. No cold/non-cold segment references.
"""
...
def churn_distribution_donut(n_churn: int, n_no_churn: int) -> go.Figure:
    ...
    fig = go.Figure(go.Pie(
        ...
        values=[n_churn, n_no_churn],
        hole=0.56,
        marker_colors=[C_DANGER, C_SUCCESS],
        textfont_size=12,
